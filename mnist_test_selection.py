...
def demo(data_type):
    ...
    sce_softmax =calculate_sce(softmax_test_prob,y_test,15)
    ...
    my_sce =calculate_sce(my_test_prob,y_test,15)

    print("softmax_sce: {:.3f}, our_sce: {:.3f}".format(sce_softmax, my_sce))
